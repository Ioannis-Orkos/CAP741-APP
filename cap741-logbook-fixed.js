    (function(){
      ...
      function renderEmptyState(){ if(!hasActiveFilters()) return ''; return '<div class="empty-state" data-transition-key="empty-state"><div class="empty-state-title">No pages match these filters</div><div class="empty-state-copy">Try a broader mix of aircraft type, registration, supervisor, or chapter, or clear the filters to show the full logbook again.</div><button type="button" data-clear-filters="1">Clear filters</button></div>'; }
